...
Item { // Bar content region
    ...
    Column { // Middle section
        ...
        Bar.BarGroup {
            ...
            Loader {
                id: verticalMediaLoader
                Layout.fillWidth: true
                Layout.fillHeight: false

                // Load VerticalMedia.qml only if an active player exists
                source: MprisController.activePlayer ? "qs/modules/ii/verticalBar/VerticalMedia.qml" : ""
            }
        }
